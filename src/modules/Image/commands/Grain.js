...
class Grain extends Command {
    constructor(module) {
        ...
        this.infos = {
            owner: ['Jacher'],
            name: 'grain',
            description: 'Apply grain resolution to an image.',
            usage: 'grain [user|attachment|url]',
            examples: ['grain Jacher', 'grain https://funnymemes.com/funnymeme.png'],
        };
